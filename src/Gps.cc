...
{
  /// \brief Number of decimal points in reading
  public: unsigned int positionPrecision{10};
...
Errors Gps::Load(ElementPtr _sdf)
{
  ...
  if (_sdf->HasElement("position_sense"))
  {
    ...
    if (elem->HasElement("precision")){
      this->dataPtr->positionPrecision = elem->Get<unsigned int>("precision");
    } else {
      //load a default value
      this->dataPtr->positionPrecision = 10;
    }
...
//////////////////////////////////////////////////
unsigned int Gps::PositionPrecision() const
{
  return this->dataPtr->positionPrecision;
}

//////////////////////////////////////////////////
void Gps::SetPositionPrecision(unsigned int _precision)
{
  this->dataPtr->positionPrecision = _precision;
}
...
{
  if (this->dataPtr->positionPrecision != _gps.PositionPrecision() )
    return false;

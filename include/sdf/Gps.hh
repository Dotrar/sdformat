...
namespace sdf
{
  ...
  class SDFORMAT_VISIBLE Gps
  {
    ...
    /// \brief Get the number of decimal places in the reading
    /// \return number of decimal precision
    public: unsigned int PositionPrecision() const;

    /// \brief Set the precision (number of decimal places) in the reading
    /// \param[in] Number of decimal decision.
    public: void SetPositionPrecision(unsigned int _precision);
